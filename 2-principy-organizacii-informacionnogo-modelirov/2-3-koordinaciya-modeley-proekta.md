...
Пространственная координация выполняется для нахождения всех моделей проекта в системе общих координат. Для выполнения данной задачи используется **базовый файл проекта** ([п. 2.2 настоящего стандарта](./2-2-faylovaya-struktura-proekta)). Настройка и проверка пространственной координации осуществляется BIM-отделом.
