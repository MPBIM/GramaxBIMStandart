...
Общие правила построения имен и требования отражены в п.4.5 настоящего стандарта.
...
Наименование видов, находящихся во вкладке **03\_ВРЕМЕННЫЕ** и **00_BIM** диспетчера проекта (п. 4.4 настоящего стандарта), не регламентируется.
