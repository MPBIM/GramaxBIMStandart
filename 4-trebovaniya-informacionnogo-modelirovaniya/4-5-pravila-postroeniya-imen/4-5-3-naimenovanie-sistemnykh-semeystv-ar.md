...
[highlight:lavender]Материалы и толщины слоев [/highlight]– постоянное поле для перечисления материалов и толщин входящих слоев. Содержит сокращенные названия (индексы) материалов на кириллице (п. 4.5.9 настоящего стандарта) и их толщины в виде цифрового обозначения. Слои указываются в порядке от наружных/верхних к внутренним/нижним и разделяются между собой дефисом "–".
