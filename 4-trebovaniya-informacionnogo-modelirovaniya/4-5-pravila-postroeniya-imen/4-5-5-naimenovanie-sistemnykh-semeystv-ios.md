...
[highlight:lemon-yellow]Материал[/highlight] – постоянное поле для обозначения материала. Содержит сокращенное название (индекс) материала на кириллице (п. 4.5.10 настоящего стандарта).
